...
//   // ✨ Better regex - matches "8x4", "8 x 4", "8×4", "8'x4'", "8'-4'", etc.
...
//   // Agar number 12 se zyada hai toh inches maan lo
//   if (w > 12 || h > 12) {
//     isInches = true;
//     wFeet = w / 12;
//     hFeet = h / 12;
...
// // ✨ NEW: Material type detection helpers
...
//     let calculatedQty = qty;
//     if (item.unit === 'CFT') {
//       // CFT = (W × T × L × Qty) / 144 (W,T in inches, L in feet)
...
//     let calculatedQty = qty;
//     if (item.unit === 'SQFT') {
//       // SQFT = (W × L × Qty) / 12 (W in inches, L in feet)
...
// table.items td.r{text-align:right;font-variant-numeric:tabular-nums}
// table.items td.c{text-align:center}
// table.items .item-detail{font-size:11.5px;color:#444;margin-top:2px;font-style:italic;font-weight:400}
...
// .ktp-footer{border:2px solid #7B1E1E;border-top:none;display:flex;background:#fff;}
// .ktp-footer-left{flex:1;padding:10px 18px;border-right:2px solid #7B1E1E;display:flex;flex-direction:column;justify-content:space-between;}
// .ktp-footer-cert{font-size:11.5px;color:#222;line-height:1.5;font-weight:500}
// .ktp-footer-for{font-size:13.5px;font-weight:bold;color:#7B1E1E;margin-top:6px}
// .ktp-footer-terms{font-size:10.5px;color:#444;margin-top:8px;line-height:1.5;font-weight:500}
// .ktp-footer-terms li{margin-bottom:2px}

// .ktp-sig-area{display:flex;justify-content:space-between;align-items:flex-end;margin-top:10px;padding-top:6px;}
// .ktp-sig-box{text-align:center}
// .ktp-sig-line{width:160px;border-top:1.5px solid #000;margin-bottom:3px}
// .ktp-sig-label{font-size:11px;color:#222;font-weight:600}
...
// .ktp-sig-right{flex:1;display:flex;flex-direction:column;justify-content:flex-end;align-items:center;padding:9px 12px;}
// .ktp-sig-right .ktp-sig-line{width:140px;border-top:1.5px solid #000;margin-bottom:3px}
// .ktp-sig-right .ktp-sig-label{font-size:11px;color:#222;font-weight:600}

// .ktp-eoe{padding:3px 14px;font-size:9.5px;color:#666;text-align:right;border-top:1px solid #E8DCC8;letter-spacing:0.5px;font-weight:500}
...
// // const PRINT_CSS = `
// // *{box-sizing:border-box;margin:0;padding:0}
// // body{font-family:'Segoe UI',Arial,sans-serif;font-size:13px;color:#000;background:#f5f5f5;-webkit-print-color-adjust:exact;print-color-adjust:exact}
// // .page-wrapper{width:210mm;min-height:297mm;margin:10px auto;background:#fff;box-shadow:0 0 10px rgba(0,0,0,0.1);display:flex;flex-direction:column;}
// // .page-content{padding:0;flex:1;display:flex;flex-direction:column;}
// // .action-bar{display:flex;gap:12px;justify-content:center;padding:14px 20px;background:linear-gradient(135deg,#FBF6F0,#F0E6DA);border-bottom:2px solid #E8DCC8;}
// // .action-btn{padding:10px 28px;border:none;border-radius:8px;font-size:14px;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;gap:8px;transition:all 0.2s;letter-spacing:0.3px;}
...
// // .ktp-header{background:linear-gradient(135deg,#5a1515,#7B1E1E,#9a2828);color:#fff;padding:18px 26px 16px;display:flex;align-items:center;gap:20px;}
...
// // .ktp-logo-circle img{width:100%;height:100%;object-fit:cover}
// // .ktp-header-center{flex:1;text-align:center}
// // .ktp-brand-name{font-size:40px;font-style:italic;font-weight:bold;font-family:Georgia,'Times New Roman',serif;line-height:1;text-shadow:1px 1px 2px rgba(0,0,0,0.2)}
// // .ktp-brand-sub{font-size:19px;font-family:Georgia,'Times New Roman',serif;font-style:italic;letter-spacing:3px;opacity:0.95;margin-top:3px}
// // .ktp-brand-addr{font-size:11.5px;margin-top:7px;opacity:0.9;letter-spacing:0.3px}
// // .ktp-header-right-space{width:72px;flex-shrink:0}

// // .ktp-meta{display:flex;justify-content:space-between;align-items:center;border-left:2px solid #7B1E1E;border-right:2px solid #7B1E1E;border-bottom:1.5px solid #7B1E1E;padding:8px 18px;background:#FBF6F0;}
// // .ktp-meta-left{display:flex;flex-direction:column;gap:2px}
// // .ktp-since{font-size:11px;font-style:italic;color:#6b5454}
// // .ktp-gstin{font-size:13px;font-weight:bold;color:#7B1E1E;letter-spacing:0.5px}
// // .ktp-dc-box{text-align:right}
// // .ktp-dc-title{font-size:19px;font-weight:bold;color:#7B1E1E;text-transform:uppercase;letter-spacing:2px;border:2px solid #7B1E1E;padding:3px 16px;display:inline-block;border-radius:4px;}
// // .ktp-dc-details{font-size:12px;margin-top:4px;color:#333}

// // .ktp-info{border-left:2px solid #7B1E1E;border-right:2px solid #7B1E1E;border-bottom:1.5px solid #7B1E1E;padding:12px 18px;background:#fff;}
// // .ktp-info-title{font-size:11px;font-weight:bold;text-transform:uppercase;color:#7B1E1E;letter-spacing:1.5px;margin-bottom:8px;border-bottom:1px solid #E8DCC8;padding-bottom:4px;}
// // .ktp-info-grid{display:flex;flex-wrap:wrap;gap:8px 22px}
// // .ktp-field{display:flex;align-items:baseline;gap:6px;margin-bottom:4px}
// // .ktp-field-label{font-size:12px;font-weight:700;white-space:nowrap;color:#333}
// // .ktp-field-value{font-size:13px;border-bottom:1px dotted #999;padding-bottom:1px;min-width:80px;color:#000;font-weight:500}
// // .ktp-field-value.wide{min-width:220px;flex:1}
// // .ktp-field-value.medium{min-width:140px}
...
// // table.items{width:100%;border-collapse:collapse}
// // table.items thead tr{background:linear-gradient(135deg,#5a1515,#7B1E1E)}
// // table.items th{padding:10px 10px;font-size:12px;font-weight:bold;color:#fff;text-align:center;border-right:1px solid rgba(255,255,255,0.2);text-transform:uppercase;letter-spacing:0.5px;}
// // table.items th:last-child{border-right:none}
// // table.items th.tl{text-align:left}
// // table.items tbody tr{border-bottom:1px solid #ddd}
// // table.items tbody tr:nth-child(even){background:#FAFAFA}
// // table.items tbody tr:nth-child(odd){background:#fff}
// // table.items td{padding:8px 10px;font-size:13px;border-right:1px solid #e0e0e0;vertical-align:top;line-height:1.4}
// // table.items td:last-child{border-right:none}
// // table.items td.r{text-align:right;font-variant-numeric:tabular-nums}
// // table.items td.c{text-align:center}
// // table.items .item-detail{font-size:11px;color:#555;margin-top:3px;font-style:italic}
// // table.items .erow td{height:26px;border-right:1px solid #e0e0e0}
// // table.items .erow td:last-child{border-right:none}

// // .ktp-words{border-left:2px solid #7B1E1E;border-right:2px solid #7B1E1E;border-top:2px solid #7B1E1E;padding:8px 18px;background:#FDF8F2;}
// // .ktp-words-label{font-size:10px;font-weight:bold;color:#7B1E1E;text-transform:uppercase;letter-spacing:1px}
// // .ktp-words-text{font-size:12.5px;font-weight:600;color:#333;margin-top:2px}

// // .ktp-footer{border:2px solid #7B1E1E;border-top:none;display:flex;background:#fff;}
// // .ktp-footer-left{flex:1;padding:12px 18px;border-right:2px solid #7B1E1E;display:flex;flex-direction:column;justify-content:space-between;}
// // .ktp-footer-cert{font-size:11px;color:#444;line-height:1.6}
// // .ktp-footer-for{font-size:13px;font-weight:bold;color:#7B1E1E;margin-top:8px}
// // .ktp-footer-terms{font-size:10px;color:#666;margin-top:10px;line-height:1.6}
// // .ktp-footer-terms li{margin-bottom:3px}

// // .ktp-sig-area{display:flex;justify-content:space-between;align-items:flex-end;margin-top:14px;padding-top:8px;}
// // .ktp-sig-box{text-align:center}
// // .ktp-sig-line{width:160px;border-top:1px solid #000;margin-bottom:4px}
// // .ktp-sig-label{font-size:10px;color:#444;font-weight:600}

// // .ktp-footer-right{width:250px;display:flex;flex-direction:column;}
// // .ktp-charge-section{border-bottom:1.5px solid #7B1E1E}
// // .ktp-charge-header{padding:6px 14px;font-size:10.5px;font-weight:bold;color:#7B1E1E;text-transform:uppercase;letter-spacing:0.5px;background:#FDF8F2;border-bottom:1px solid #E8DCC8;}
// // .ktp-charge-row{display:flex;justify-content:space-between;padding:5px 14px;font-size:11.5px;color:#333;border-bottom:1px solid #f0e6da;}
// // .ktp-charge-row:last-child{border-bottom:none}
// // .ktp-charge-name{max-width:140px;overflow:hidden;text-overflow:ellipsis}
// // .ktp-charge-amt{font-weight:600;font-variant-numeric:tabular-nums}

// // .ktp-total-row{display:flex;justify-content:space-between;padding:7px 14px;font-size:12.5px;border-bottom:1px solid #E8DCC8;color:#333;}
// // .ktp-total-row .ktp-total-label{font-weight:500}
// // .ktp-total-row .ktp-total-val{font-weight:600;font-variant-numeric:tabular-nums}
// // .ktp-total-row.grand{background:linear-gradient(135deg,#5a1515,#7B1E1E);color:#fff;font-size:15px;font-weight:bold;border-bottom:none;padding:10px 14px;}
// // .ktp-total-row.grand .ktp-total-val{letter-spacing:0.5px}

// // .ktp-sig-right{flex:1;display:flex;flex-direction:column;justify-content:flex-end;align-items:center;padding:10px 14px;}
// // .ktp-sig-right .ktp-sig-line{width:140px;border-top:1px solid #000;margin-bottom:4px}
// // .ktp-sig-right .ktp-sig-label{font-size:10px;color:#444;font-weight:600}

// // .ktp-eoe{padding:4px 14px;font-size:9px;color:#888;text-align:right;border-top:1px solid #E8DCC8;letter-spacing:0.5px;}
// // .ktp-no-price-box{padding:24px 14px;text-align:center;color:#7B1E1E;font-weight:bold;font-size:13px;flex:1;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:6px;}

// // @media print{
// // html{margin:0!important;padding:0!important}
// // body{margin:0!important;padding:0!important;background:#fff!important;font-size:13px!important}
// // .action-bar{display:none!important}
// // .page-wrapper{width:100%!important;min-height:100%!important;margin:0!important;padding:0!important;box-shadow:none!important}
// // .page-content{min-height:100%!important}
// // .ktp-header{background:#7B1E1E!important;-webkit-print-color-adjust:exact;print-color-adjust:exact}
...
//   const chargesTotal = chargesList.reduce((s, ch) => s + ch.amount, 0);
//   const challanTotal = hidePrice ? 0 : itemsTotal + chargesTotal;
//   const poLine = order.poNumber
//     ? `<div class="ktp-field"><span class="ktp-field-label">PO No.:</span><span class="ktp-field-value medium">${order.poNumber}</span></div>`
//     : "";
//   const gstLine = order.gstCustomerName
//     ? `<div class="ktp-field"><span class="ktp-field-label">GST Party:</span><span class="ktp-field-value medium">${order.gstCustomerName}</span></div>`
//     : "";
//   let sno = 0;
//   const itemRows = regularItems.map((it) => {
//     sno++;
//     let qtyVal = it.calculatedQty
//       ? parseFloat(it.calculatedQty).toFixed(3)
//       : it.sentQty;
//     let qtyWithUnit = it.unit ? `${qtyVal} ${it.unit}` : qtyVal;
//     if (
//       it.isSheet &&
...
//     );
//   const isSheetMaterialFn = (name) =>
//     /mdf|hdhdr|hdmr|door|wpc|ply|block|flush|laminate|board|sunmica|formica|veneer/i.test(
//       name || "",
//     );
//   const isRailingMaterial = (name) => /railing/i.test(name);
...
//     try {
//       const challanNo = genChallanNo();
//       const challanTotal = valid.reduce(
//         (s, it) =>
...
//           {/* ✨ Smart Badges */}
//           {isTimberWood(item) && (
//             <span className="unit-badge wood-badge">Timber Wood</span>
//           )}
//           {isWoodenCladding(item) && (
//             <span className="unit-badge wood-badge">Wooden Cladding</span>
//           )}
//           {isWoodenBaluster(item) && (
//             <span className="unit-badge wood-badge">Baluster</span>
//           )}
//           {isSolidSurface(item) && (
//             <span className="unit-badge wood-badge">Solid Surface</span>
//           )}
//           {isCeilingPlank(item) && (
//             <span className="unit-badge wood-badge">Ceiling Plank</span>
//           )}
//           {item.isWood &&
//             !item.isSheet &&
//             !isTimberWood(item) &&
...
//             !isCeilingPlank(item) &&
//             !isSolidSurface(item) && (
//               <span className="unit-badge wood-badge">Sheet/Door</span>
//             )}
//           {!item.skuCode && item.product && (
//             <span className="unit-badge custom-badge">Custom</span>
//           )}
//           {(item.isSheet || isSolidSurface(item) || isCeilingPlank(item)) &&
//             item.areaPerPiece && (
//               <span
//                 style={{
//                   fontSize: 10,
...
//           <button
//             className="icon-btn"
//             onClick={() => removeItemFromGroup(group.groupId, item.uid)}
//           >
//             <Trash2 size={14} />
//           </button>
//         </div>
...
//         {/* ✨ UPDATED Unit Dropdown - Material specific */}
//         <div>
//           {isSolidSurface(item) ? (
//             <select
//               className="kt-input"
...
//               onChange={(e) =>
//                 updateGroupItem(group.groupId, item.uid, "unit", e.target.value)
//               }
//             >
...
//         {/* ✨ Length Input - Wood/Cladding/Baluster ke liye */}
//       {/* Length input - Timber Wood, Wooden Cladding, Wooden Baluster ke liye */}
...
//         {/* ✨ Custom Size for Sheet/Solid Surface/Ceiling Plank (when SQFT) */}
//         {(item.isSheet || isSolidSurface(item) || isCeilingPlank(item)) &&
//           item.unit === "SQFT" && (
...
//                 onChange={(e) =>
//                   updateGroupItem(group.groupId, item.uid, "customLength", e.target.value)
//                 }
//                 style={{ width: 75 }}
//               />
//               <span style={{ color: T.textMuted, fontSize: 12 }}>ft ×</span>
...
//                 onChange={(e) =>
//                   updateGroupItem(group.groupId, item.uid, "customWidth", e.target.value)
//                 }
//                 style={{ width: 75 }}
//               />
//               <span style={{ color: T.textMuted, fontSize: 12 }}>ft</span>
...
//                   ={" "}
//                   {(
//                     parseFloat(item.customLength) * parseFloat(item.customWidth)
//                   ).toFixed(2)}{" "}
//                   sqft/pc
//                 </span>
//               )}
...
//             value={item.quantity}
//             onChange={(e) =>
//               updateGroupItem(group.groupId, item.uid, "quantity", e.target.value)
//             }
//           />
//         </div>
...
//             value={item.rate}
//             onChange={(e) =>
//               updateGroupItem(group.groupId, item.uid, "rate", e.target.value)
//             }
//           />
//         </div>
...
//             onChange={(e) =>
//               updateGroupItem(group.groupId, item.uid, "specification", e.target.value)
//             }
//           />
//         </div>
//       </div>

//       {/* ✨ UPDATED Calculation Display - Material-specific */}
//       {item.product && !orderForm.hidePrice && (
//   <div className="calc-display">
//     {isSolidSurface(item) ? (
//       <>
...
//       <>
//         <span style={{ fontWeight: 600 }}>
//           {item.unit === 'SQFT' && `${item.quantity || 0} pcs × ${item.areaPerPiece?.toFixed(2) || 0} sqft = ${item.calculatedQty.toFixed(2)} SQFT`}
//           {item.unit === 'RFT' && `Total RFT: ${item.calculatedQty.toFixed(2)}`}
//           {item.unit === 'Per Piece' && `Qty: ${item.calculatedQty}`}
//         </span>
//         {' • '}<span style={{ fontWeight: 'bold', color: T.maroon }}>₹{item.amount.toLocaleString()}</span>
//       </>
//     ) : isWoodenBaluster(item) ? (
  ...
  if (!hidePrice) {
    footerRightContent = `
      ...
      ${gstRate > 0 ? `
        ...
        <div class="ktp-total-row" style="background:#FDF8F2;">
          <span class="ktp-total-label" style="color:#7B1E1E;font-weight:700;">GST (${gstRate}%)</span>
          <span class="ktp-total-val" style="color:#7B1E1E;font-weight:700;">₹${calculatedGST.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
        </div>
      ` : ''}
...
export default function OrderChallanBilling() {
  ...
  const isWoodMaterial = item => /timber|wood|lakdi|railing/i.test(item?.materialType || item?.product || '');
  const isSheetMaterialFn = name => /mdf|hdhdr|hdmr|door|wpc|ply|block|flush|laminate|board|sunmica|formica|veneer/i.test(name || '');
  const isRailingMaterial = name => /railing/i.test(name);
  ...
  const handleSubmitChallan = async () => {
    ...
    try {
      const challanNo = genChallanNo();
      const itemsSubTotal = valid.reduce((s, it) => s + parseFloat(it.sendingQty || 0) * parseFloat(it.rate || 0), 0);
      const challanGSTRate = parseFloat(selectedOrder.gstRate || 0);
      const challanGSTAmount = challanGSTRate > 0 ? (itemsSubTotal * challanGSTRate / 100) : 0;
      ...
      {activeTab === 'challans' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          {filteredChallans.map(ch => {
            ...
            const gstChargeEntry = allChargesFromChallan.find(c =>
              c.type === 'gst' || c.name.toLowerCase().includes('gst')
            );
            const regularCharges = allChargesFromChallan.filter(c =>
              c.type !== 'gst' && !c.name.toLowerCase().includes('gst')
            );

            const challanGstRate = parseFloat(ch.gstRate || order?.gstRate || 0);
            const challanGstAmount = parseFloat(ch.gstAmount || gstChargeEntry?.amount || order?.tax || 0);
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
                  <div>
                    <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
                      ...
                      {challanGstRate > 0 && (
                        <span className="status-pill" style={{ background: T.infoBg, color: T.infoColor }}>
                          GST {challanGstRate}%
                        </span>
                      )}
                    </div>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    <button className="btn-white" style={{ padding: '5px 12px', fontSize: 12 }} onClick={() => {
                      if (order) openPDFView(getChallanPrintHTML(order, ch, ch.hidePrice, regularCharges, challanGstRate, challanGstAmount));
                    }}>
                      <Eye size={12} /> View
                    </button>
                    <button className="btn-maroon" style={{ padding: '5px 12px', fontSize: 12 }} onClick={() => {
                      if (order) openPDFPrint(getChallanPrintHTML(order, ch, ch.hidePrice, regularCharges, challanGstRate, challanGstAmount));
                    }}>
                      <Printer size={12} /> Print
                    </button>
                  </div>
                          ...
                          <div key={`item-${item.uid}`} className="item-subrow">
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                                ...
                                {item.isWood && !item.isSheet && !isTimberWood(item) && !isWoodenCladding(item) && !isWoodenBaluster(item) && (
                                  <span className="unit-badge wood-badge">Wood</span>
                                )}
                                {item.isSheet && !isCeilingPlank(item) && !isSolidSurface(item) && (
                                  <span className="unit-badge wood-badge">Sheet/Door</span>
                                )}
                                {!item.skuCode && item.product && <span className="unit-badge custom-badge">Custom</span>}
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 10 }}>
                              ...
                              <div>
                                <input type="number" className="kt-input"
                                  placeholder={(item.isSheet || isSolidSurface(item) || isCeilingPlank(item)) && item.unit === 'SQFT' ? 'Pieces' : 'Qty'}
                                  value={item.quantity}
                                  onChange={e => updateGroupItem(group.groupId, item.uid, 'quantity', e.target.value)}
                                />
                              </div>
                              <div>
                                <input type="number" className="kt-input"
                                  placeholder={(item.isSheet || isSolidSurface(item) || isCeilingPlank(item)) && item.unit === 'SQFT' ? 'Rate/SQFT' : 'Rate'}
                                  value={item.rate}
                                  onChange={e => updateGroupItem(group.groupId, item.uid, 'rate', e.target.value)}
                                />
                              </div>
                                ...
                                {isSolidSurface(item) ? (
                                  <>
                                    {(() => {
                                      ...
                                      return (
                                        <span style={{ fontWeight: 600 }}>
                                          {item.quantity || 0} pcs × {effectiveArea.toFixed(2)} sqft = {item.calculatedQty.toFixed(2)} SQFT
                                        </span>
                                      );
                                    })()}
                                    {' • '}<span style={{ fontWeight: 'bold', color: T.maroon }}>₹{item.amount.toLocaleString()}</span>
