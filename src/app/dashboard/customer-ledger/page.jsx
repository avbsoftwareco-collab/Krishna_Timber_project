...
/* ✅ Simple document container - no forced height */
.ledger-doc{width:210mm;margin:10px auto;background:#fff;box-shadow:0 0 10px rgba(0,0,0,0.1);}
...
.ktp-table-wrap{border-left:2px solid #000;border-right:2px solid #000;}
...
table.items td{padding:5px 10px;font-size:13px;border-right:1px solid #000;vertical-align:top;line-height:1.3;color:#000;font-weight:500}
...
.ktp-footer{border:2px solid #000;display:flex;background:#fff;padding:10px 18px;justify-content:space-between;page-break-inside:avoid !important;break-inside:avoid !important;}
...
/* ✅ CRITICAL: No forced heights */
.ledger-doc{width:100%!important;margin:0!important;padding:0!important;box-shadow:none!important;display:block!important;}
...
table.items thead tr{background:#fff!important;}
table.items th{background:#fff!important;color:#000!important;border-right:1.5px solid #000!important;border-bottom:2px solid #000!important;border-top:1.5px solid #000!important;font-size:13px!important;padding:8px 10px!important;}
table.items th:last-child{border-right:none!important;}
table.items td{border-right:1px solid #000!important;font-size:13px!important;padding:5px 10px!important;line-height:1.3!important;}
...
<style>${PRINT_CSS}</style></head><body>
  ...
  <!-- ✅ FIX: Everything in single content wrapper, no forced heights -->
